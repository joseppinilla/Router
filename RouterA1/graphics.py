...
def drawRouter(fin,blocks,nets):
    ...
    for ob in range(0,obs):       
        ...
        blocks[index][0].setFill(color_rgb(0,0,255))
        blocks[index][1] = -1
